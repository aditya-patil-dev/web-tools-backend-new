    ...
    async complete(request) {
        ...
        try {
            ...
            if (!((_f = choice === null || choice === void 0 ? void 0 : choice.message) === null || _f === void 0 ? void 0 : _f.content)) {
                throw new HttpException_1.default(502, "DeepSeek returned an empty response");
            }
            return {
            ...
            if (status === 401)
                throw new HttpException_1.default(502, "DeepSeek: Invalid API key");
            if (status === 429)
                throw new HttpException_1.default(429, "DeepSeek: Rate limit exceeded");
            if (status === 503)
                throw new HttpException_1.default(503, "DeepSeek: Service temporarily unavailable");
            throw new HttpException_1.default(502, `DeepSeek API error: ${message}`);
        }
    }
}
