...
const seed = async (dropFirst = false) => {
    try {
        if (dropFirst) {
            ...
            await index_schema_1.default.schema.dropTableIfExists("billing_accounts");
        }
        const exists = await index_schema_1.default.schema.hasTable("billing_accounts");
        if (!exists) {
            await index_schema_1.default.schema.createTable("billing_accounts", (table) => {
...
exports.seed = seed;
//# sourceMappingURL=billing_accounts.schema.js.map