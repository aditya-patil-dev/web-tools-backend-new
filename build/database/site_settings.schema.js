...
const seed = async (dropFirst = false) => {
    try {
        if (dropFirst) {
            ...
            await index_schema_1.default.schema.dropTableIfExists("site_settings");
        }
        const exists = await index_schema_1.default.schema.hasTable("site_settings");
        if (!exists) {
            await index_schema_1.default.schema.createTable("site_settings", (table) => {
            ...
            /*
                  ...
                  */
            await (0, index_schema_1.default)("site_settings").insert({
...
exports.seed = seed;
//# sourceMappingURL=site_settings.schema.js.map