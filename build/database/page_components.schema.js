...
const seed = async (dropFirst = false) => {
    try {
        if (dropFirst) {
            ...
            await index_schema_1.default.schema.dropTableIfExists("page_components");
        }
        const exists = await index_schema_1.default.schema.hasTable("page_components");
        if (!exists) {
            await index_schema_1.default.schema.createTable("page_components", (table) => {
...
exports.seed = seed;
//# sourceMappingURL=page_components.schema.js.map