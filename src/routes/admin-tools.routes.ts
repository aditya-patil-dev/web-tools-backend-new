...
import AdminToolsController from "../controllers/admin-tools.controllers";
// import authMiddleware from "../middlewares/auth.middleware";
// import roleMiddleware from "../middlewares/role.middleware";

class AdminToolsRoute implements Route {
  public path = "/admin/tools";
  public router = Router();
  public controller = new AdminToolsController();
...
export default AdminToolsRoute;